...
func Setup(app *fiber.App, cfg *config.Config) {
	...
	compression.Post("/jobs", compressionHandler.CreateJob)
	compression.Get("/jobs", compressionHandler.ListJobs)
	compression.Get("/jobs/:id", compressionHandler.GetJob)
	compression.Delete("/jobs/:id", compressionHandler.CancelJob)
	compression.Get("/stats", compressionHandler.GetStats)
	compression.Get("/algorithms", compressionHandler.ListAlgorithms)
