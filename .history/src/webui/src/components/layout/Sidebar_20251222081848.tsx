...
const navigationGroups: NavGroup[] = [
  {
    ...
    items: [
      ...
      { id: 'compression', label: 'Compression', href: '/compression', icon: FolderArchive },
    ],
  },
  {
    id: 'security',
    ...
    items: [
      ...
      { id: 'encryption', label: 'Encryption', href: '/encryption', icon: Lock },
    ],
  },
  {
    id: 'network',
...
export function Sidebar() {
  ...
  return (
    ...
    >
      ...
      `}>
        {collapsed ? (
          <SimpleTooltip content={`${activeAgentCount} agents active`} side="right">
