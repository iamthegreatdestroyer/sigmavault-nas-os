...
import type { WebSocketMessage, JsonRpcRequest, JsonRpcResponse } from '@/types';
...
export function useWebSocket(options: UseWebSocketOptions = {}): UseWebSocketReturn {
  ...
  const pendingRpcRef = useRef<Map<string | number, {
  ...
  }, [cleanup, setWsConnected, setLastPing, startPingPong, onOpen, onClose, onError, onMessage]);
  ...
  // Send RPC
  // --------------------------------------------------------------------------
  const sendRpc = useCallback(<T,>(method: string, params?: unknown[]): Promise<T> => {
