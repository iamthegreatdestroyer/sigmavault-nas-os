...
function WebSocketManager({ children }: { children: React.ReactNode }) {
  ...
  const { setConnected, setReconnecting, handleWebSocketMessage } = useAppStore(
    (state) => ({
...
function ToastNotifications() {
  const { notifications, dismissNotification } = useAppStore((state) => ({
  ...
  return (
    <Routes>
      <Route element={<MainLayout />}>
        ...
        <Route path="/compression" element={<PlaceholderPage title="Compression" />} />
        <Route path="/security" element={<PlaceholderPage title="Security" />} />
        <Route path="/encryption" element={<PlaceholderPage title="Encryption" />} />
        <Route path="/network" element={<PlaceholderPage title="PhantomMesh VPN" />} />
        <Route path="/agents" element={<PlaceholderPage title="Agent Swarm" />} />
...
export function App() {
  ...
  if (!isHydrated) {
    return <FullPageLoader text="Loading SigmaVault..." />;
  }
