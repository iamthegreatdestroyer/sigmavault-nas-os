...
class JobDetailView(Adwaita.NavigationPage):
    ...
    def _build_ui(self) -> None:
        ...
        file_group.add(self._make_row(
            "Original Size", format_bytes(job.original_size),
            icon="document-open-symbolic",
        ))
        file_group.add(self._make_row(
            "Compressed Size", format_bytes(job.compressed_size),
            icon="package-x-generic-symbolic",
        ))
        file_group.add(self._make_row(
            "Compression Ratio", format_ratio(job.compression_ratio),
        ...
        proc_group.add(self._make_row(
            "Elapsed Time", format_duration(job.elapsed_seconds),
            icon="preferences-system-time-symbolic",
        ))
        proc_group.add(self._make_row(
            "Throughput", format_throughput(job.throughput_mbps),
